...
def evalution_CL(args):
    order= args.permutation
    ...
    for method in methods:
        root_path = args.save+f'/{method}/'
        results = load_results(root_path,order,1000)
        fine_tuning_results = load_results_onefile(args.save+'/fine_tuning_woCL/1000shot/benchmark_result.csv')
        zero_shot_results = load_results_onefile(args.save+'/zero-shot/1000shot/benchmark_result.csv')
